...
extension ProductQueryWhereSort on QueryBuilder<Product, Product, QWhere> {
  ...
  QueryBuilder<Product, Product, QAfterWhere> anyIsAvailable() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension ProductQueryWhere on QueryBuilder<Product, Product, QWhereClause> {
  ...
  QueryBuilder<Product, Product, QAfterWhereClause> isAvailableEqualTo(
      bool isAvailable) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
  ...
  QueryBuilder<Product, Product, QAfterWhereClause> isAvailableNotEqualTo(
      bool isAvailable) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension ProductQueryFilter
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> isLiquorEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isLiquor',
...
extension ProductQuerySortBy on QueryBuilder<Product, Product, QSortBy> {
  ...
  QueryBuilder<Product, Product, QAfterSortBy> sortByIsLiquorDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isLiquor', Sort.desc);
    });
  }
...
extension ProductQuerySortThenBy
  ...
  QueryBuilder<Product, Product, QAfterSortBy> thenByIsLiquorDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isLiquor', Sort.desc);
    });
  }
...
extension ProductQueryWhereDistinct
  ...
  QueryBuilder<Product, Product, QDistinct> distinctByIsLiquor() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isLiquor');
    });
  }
...
extension ProductQueryProperty
  ...
  QueryBuilder<Product, bool, QQueryOperations> isLiquorProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isLiquor');
    });
  }
